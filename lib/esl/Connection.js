...
Connection.prototype._onConnect = function() {
    ...
    if( this.isReconnect === true )
    {
        ...
        console.log(this.eventsThatNeedstoSetAgain);
        if(eslSocket && typeof eslSocket.fCallBack !== "undefined" && eslSocket.fCallBack)
        {
            eslSocket.fCallBack();
        }
        this.subscribe(this.eventsThatNeedstoSetAgain);
        this.isReconnect = false;
    }
